...
def generate_samples_random(size = 1000,sType = 'CI',dx = 1,dy = 1,dz = 20,nstd = 0.5,freq = 1.0):
...
def random_helper(sims):
	...
	np.random.seed()
	random.seed()
	L = generate_samples_random(size=sims[0],sType=sims[1],dx=sims[2],dy=sims[3],dz=sims[4],nstd=sims[5],freq=sims[6])
...
def parallel_random_sample_gen(nsamples = 1000,dx = 1,dy = 1,dz = 20,nstd = 0.5,freq = 1,filetype = '../data/dim20_random/datafile',num_data = 50, num_proc = 4):
	''' 
